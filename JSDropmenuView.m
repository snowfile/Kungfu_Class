...
#define MenuBackgroundColor GARYTEXTCOLOR
#define MenuLineColor UIColoerFromRGB(0xa8a8a8)
...
- (void)setupView {
    ...
    self.titleLabel = ({
        ...
        if (SCREEN_WIDTH == 320) {
            titleLabel.font = [UIFont systemFontOfSize:15*Screen320Scale];
            
        }else if (SCREEN_WIDTH == 375) {
            titleLabel.font = [UIFont systemFontOfSize:15*Screen375Scale];

        }else {
            titleLabel.font = [UIFont systemFontOfSize:15*Screen414Scale];
...
- (void)setupView {
    ...
    [path addLineToPoint:CGPointMake(14, 15)];
    [path closePath];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (Screen_Width == 320) {
        return 45*Screen320Scale;
    }else if (Screen_Width == 375) {
        return 45*Screen375Scale;
    }

    return 45*Screen414Scale;
}
